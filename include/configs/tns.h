...
#define CONFIG_BSP_VERSION_STRING	"BSP version 0.1.001_internal_testing"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
  "filesize=0\0" \
  "ram_start=20000000\0" \
  "kernel_start=20008000\0"      \
  "android_ramdisk_start=21000000\0" \
  "android_system_start=C4000000\0" \
  "clear=setenv filesize 0\0"  \
  "_prg_bl=nand erase 0 100000; nand write ${ram_start} 0 100000; run clear\0" \
  "_prg_kn=nand erase 600000 500000; nand write ${kernel_start} 600000 500000; run clear\0" \
  "_prg_ramdisk=nand erase b00000 300000; nand write ${android_ramdisk_start} b00000 300000; run clear\0" \
  "_prg_system=nand erase e00000 5a00000; nand write.yaffs ${android_system_start} e00000 ${filesize}; run clear\0" \
  "_prg_data=nand erase b800000; nand write.yaffs ${ram_start} b800000 ${filesize}; run clear\0" \
  "prg_uboot_dnw=dnw ${ram_start}; run _prg_bl\0" \
  "prg_uboot_insd=movi init hc 0; fatload mmc 0 ${ram_start} u-boot.bin; run _prg_bl\0" \
  "kernel_dnw=dnw ${kernel_start}\0"     \
  "kernel_insd=movi init hc 0; fatload mmc 0 ${kernel_start} zImage\0" \
  "prg_kernel_dnw=run kernel_dnw; run _prg_kn\0" \
  "prg_kernel_insd=run kernel_insd; run _prg_kn\0" \
  "ramdisk_dnw=dnw ${android_ramdisk_start};\0" \
  "ramdisk_insd=movi init hc 0; fatload mmc 0 ${android_ramdisk_start} ramdisk-uboot.img;\0" \
  "prg_ramdisk_dnw=run ramdisk_dnw; run _prg_ramdisk\0" \
  "prg_ramdisk_insd=run ramdisk_insd; run _prg_ramdisk; \0" \
  "prg_system_dnw=dnw ${ram_start}; run _prg_system\0" \
  "prg_system_insd=movi init hc 0; fatload mmc 0 ${android_system_start} system.img; run _prg_system\0" \
  "prg_data_dnw=dnw ${ram_start}; run _prg_data\0" \
  "prg_data_insd=movi init hc 0; fatload mmc 0 ${ram_start} userdata.img; run _prg_data\0" \
  "prg_all_insd=run prg_uboot_insd; run prg_kernel_insd; run prg_ramdisk_insd; run prg_system_insd; run prg_data_insd\0"
...
#define CFG_PROMPT              "TNS # "   /* Monitor Command Prompt       */
...
#define	DMC0_MEMCONTROL		0x00202200	// MemControl	BL=4, 1 chip, LPDDR2 type, dynamic self refresh, force precharge, dynamic power down off
#define DMC0_MEMCONFIG_0	0x30F01223	// MemConfig0	256MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
#define DMC0_MEMCONFIG_1	0x00F01223	// MemConfig1
#define DMC0_TIMINGA_REF	0x00000618	// TimingAref	7.8us*133MHz=1038(0x40E), 100MHz=780(0x30C), 20MHz=156(0x9C), 10MHz=78(0x4E)
#define DMC0_TIMING_ROW		0x1A254349	// TimingRow	for @200MHz
#define DMC0_TIMING_DATA	0x23240306	// TimingData	CL=3
#define	DMC0_TIMING_PWR		0x0A1C0235	// TimingPower

#define	DMC1_MEMCONTROL		0x00202200	// MemControl	BL=4, 1 chip, LPDDR2 type, dynamic self refresh, force precharge, dynamic power down off
#define DMC1_MEMCONFIG_0	0x40F01223	// MemConfig0	512MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
#define DMC1_MEMCONFIG_1	0x00F01223	// MemConfig1
#define DMC1_TIMINGA_REF	0x00000618	// TimingAref	7.8us*133MHz=1038(0x40E), 100MHz=780(0x30C), 20MHz=156(0x9C), 10MHz=78(0x4
#define DMC1_TIMING_ROW		0x1A254349	// TimingRow	for @200MHz
#define DMC1_TIMING_DATA	0x23240306	// TimingData	CL=3
#define	DMC1_TIMING_PWR		0x0A1C0235	// TimingPower
...
#define SDRAM_BANK_SIZE         0x08000000    /* 256 MB */
...
#define CONFIG_IDENT_STRING	" for TNS"
...
#define CONFIG_BOOTCOMMAND	"nand read C0008000 600000 400000; nand read 20A00000 B00000 180000; bootm C0008000 20A00000"
