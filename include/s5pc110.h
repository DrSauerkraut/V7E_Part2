...
#define rCLK_GATE_IP1		        *(volatile unsigned long *)(0xE0100464)
#define rCLK_GATE_BLOCK		*(volatile unsigned long *)(0xE0100480)
#define rCLK_DIV1		                *(volatile unsigned long *)(0xE0100304)
#define rCLK_DIV0		                *(volatile unsigned long *)(0xE0100300)


//GPIO PWR_HOLD
#define PS_HOLD_CONTROL		*(volatile unsigned long *)(0xE010E81C)

//vibrator GPIO
#define GPJ3CON		*(volatile unsigned long *)(0xE02002A0)
#define GPJ3DAT		*(volatile unsigned long *)(0xE02002A4)
...
#define GPF0DAT				*(volatile unsigned long *)(0xE0200124)	 
#define GPF0PUD				*(volatile unsigned long *)(0xE0200128)		 
#define GPF0DRV				*(volatile unsigned long *)(0xE020012C)
#define GPF0CONPDN			(ELFIN_GPIO_BASE + GPF0CONPDN_OFFSET)	 
#define GPF0PUDPDN			(ELFIN_GPIO_BASE + GPF0PUDPDN_OFFSET)	

#define GPF1CON				*(volatile unsigned long *)(0xE0200140)
#define GPF1DAT				*(volatile unsigned long *)(0xE0200144) 
#define GPF1PUD				*(volatile unsigned long *)(0xE0200148)		 
#define GPF1DRV				*(volatile unsigned long *)(0xE020014C)
#define GPF1CONPDN			(ELFIN_GPIO_BASE + GPF1CONPDN_OFFSET)	 
#define GPF1PUDPDN			(ELFIN_GPIO_BASE + GPF1PUDPDN_OFFSET)	

#define GPF2CON				*(volatile unsigned long *)(0xE0200160)
#define GPF2DAT				*(volatile unsigned long *)(0xE0200164)	 
#define GPF2PUD				*(volatile unsigned long *)(0xE0200168)			 
#define GPF2DRV				*(volatile unsigned long *)(0xE020016C)	 
#define GPF2CONPDN			(ELFIN_GPIO_BASE + GPF2CONPDN_OFFSET)	 
#define GPF2PUDPDN			(ELFIN_GPIO_BASE + GPF2PUDPDN_OFFSET)	 


#define DISPLAYCONTROL			*(volatile unsigned long *)(0xE0107008)	
...
#define GPF3DAT				*(volatile unsigned long *)(0xE0200184)		 
#define GPF3PUD				*(volatile unsigned long *)(0xE0200188)			 
#define GPF3DRV				*(volatile unsigned long *)(0xE020018C)	
...
#define GPH3PUD		*(volatile unsigned long *)(0xE0200C68)
...
#define GPJ4CON				*(volatile unsigned long *)(0xE02002C0)
#define GPJ4DAT				*(volatile unsigned long *)(0xE02002C4) 
...
#define TCFG0_REG		*(volatile unsigned long *)(0xE2500000)
#define TCFG1_REG		*(volatile unsigned long *)(0xE2500004)
#define TCON_REG		*(volatile unsigned long *)(0xE2500008)
	
#define TCNTB0_REG			*(volatile unsigned long *)(0xE250000C)
#define TCMPB0_REG			*(volatile unsigned long *)(0xE2500010)
#define TCNTO0_REG			*(volatile unsigned long *)(0xE2500014)
	
#define TCNTB1_REG		*(volatile unsigned long *)(0xE2500018)
#define TCMPB1_REG	        *(volatile unsigned long *)(0xE250001C)
#define TCNTO1_REG	        *(volatile unsigned long *)(0xE2500020)
