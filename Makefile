...
ifeq ($(CONFIG_UBOOT_COMBINE),y)
		@./tools/pad_uboot $@
		@mv u-boot-256KB.bin u-boot.bin
endif
...
tns_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x tns venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/tns/config.mk

pdc2_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x pdc2 venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/pdc2/config.mk
	@echo "BSP_VERSION = '\"BSP 0.1.`svnversion 2> /dev/null`\"'" >> $(obj)board/venus/pdc2/config.mk
	@echo "CONFIG_UBOOT_COMBINE = y" >> $(obj)include/config.mk

pdc3_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x pdc2 venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/pdc2/config.mk
	@echo "BSP_VERSION = '\"BSP 0.1.`svnversion 2> /dev/null`\"'" >> $(obj)board/venus/pdc2/config.mk
	@echo "CONFIG_UBOOT_COMBINE = y" >> $(obj)include/config.mk
...
ch2_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x ch2 venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/ch2/config.mk
	@echo "BSP_VERSION = '\"BSP 0.3.`svnversion 2> /dev/null`\"'" >> $(obj)board/venus/ch2/config.mk
	@echo "CONFIG_UBOOT_COMBINE = y" >> $(obj)include/config.mk

cm1_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x cm1 venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/cm1/config.mk
	@echo "BSP_VERSION = '\"BSP 0.1.`svnversion 2> /dev/null`\"'" >> $(obj)board/venus/cm1/config.mk
	@echo "CONFIG_UBOOT_COMBINE = y" >> $(obj)include/config.mk

tnsx_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x tnsx venus s5pc110
	@echo "TEXT_BASE = 0x33e00000" > $(obj)board/venus/tnsx/config.mk
	@echo "BSP_VERSION = '\"BSP 0.1.`svnversion 2> /dev/null`\"'" >> $(obj)board/venus/tnsx/config.mk
	@echo "CONFIG_UBOOT_COMBINE = y" >> $(obj)include/config.mk
