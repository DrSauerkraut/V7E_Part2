...
void sleep_gpio_GPA0_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPA0[7]: "GPS_UART_nRTS",  GPA0[6]: "GPS_UART_nCTS",   GPA0[5]: "GPS_UART_TX",  GPA0[4]: "GPS_UART_RX";
	 *  GPA0[3]: "BT_RTS", 	       GPA0[2]: "BT_CTS", 	   GPA0[1]: "BT_TX",        GPA0[0]: "BT_RX";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPA0[7] = "00" Output 0, GPA0[6] = "00" Output 0, GPA0[5] = "00" Output 0, GPA0[4] = "00" Output 0;
	 *  GPA0[3] = "00" Output 0, GPA0[2] = "00" Output 0, GPA0[1] = "00" Output 0, GPA0[0] = "00" Output 0;
	 *  
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	/*sleep_config = readl(GPA0CONPDN);
	sleep_config &= ~( 1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1 );
	sleep_config &= ~( 1 << 14 | 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0 );*/		
	writel(sleep_config, GPA0CONPDN);
...
void sleep_gpio_GPA1_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPA1[3]: "EMR_Touch_TX", 	       GPA1[2]: "EMR_Touch_RX", 	   GPA1[1]: "Debug_TX",        GPA1[0]: "Debug_RX";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPA1[3] = "00" Output 0, GPA1[2] = "00" Output 0, GPA1[1] = "00" Output 0, GPA1[0] = "00" Output 0;
	 *  
	 *  Register Bit [7 ~ 0] = 0000 0000 
	 */
	/*sleep_config = readl(GPA1CONPDN);
	sleep_config &= ~(1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~(1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);	*/
	writel(sleep_config, GPA1CONPDN);
	 ...
	 *  Register Bit [7 ~ 0] = 0000 0000
	 */
	sleep_pud = readl(GPA1PUDPDN);
	sleep_pud &= ~(1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPA1PUDPDN);
...
void sleep_gpio_GPB_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPB[7]: "GPS_REGPU",       GPB[6]: "GPS_RST_N",        GPB[5]: "3G_PWR_ON",       GPB[4]: "3G_PON_RST";
	 *  GPB[3]: "CAM_EN", 	       GPB[2]: "SELB1", 	   GPB[1]: "HDMI-SDA",        GPB[0]: "HDMI-SCL";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPB[7] = "11"  Previous, GPB[6] = "11"  Previous,   GPB[5] = "11"  Previous,      GPB[4] = "11"  Previous;
	 *  GPB[3] = "00" Output 0,  GPB[2] = "00" Output 0, 	GPB[1] = "01" Output 1,       GPB[0] = "01" Output 1;
	 *  
	 *  Register Bit [15 ~ 0] = 1111 1111 0000 0101
	 */
	sleep_config = readl(GPBCONPDN);
	sleep_config |= (1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 2 | 1 << 0);
	sleep_config &= ~( 1 << 14 | 1 << 12 | 1<< 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 3 | 1 << 1);		
	writel(sleep_config, GPBCONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPBPUDPDN);
	sleep_pud &= ~( 1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPBPUDPDN);
...
void sleep_gpio_GPC0_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPC0[4]: "SF_I2C_DATA";
	 *  GPC0[3]: "CAM_5M_RST", 	       GPC0[2]: "3G_PWRON_Out", 	   GPC0[1]: "Wakeup_IN",        GPC0[0]: "3G_PWREN";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPC0[4] = "01" Output 1;
	 *  GPC0[3] = "00" Output 0,  		GPC0[2] = "10" Input, 		  GPC0[1] = "00" Output 0,       GPC0[0] = "01" Output 1;
	 *  
	 *  Register Bit [9 ~ 0] = 01 0010 0001
	 */
	/*sleep_config = readl(GPC0CONPDN);
	sleep_config |= ( 1 << 8 | 1 << 5 | 1 << 0 );
	sleep_config &= ~( 1 << 9 | 1 << 7 | 1 << 6 | 1<< 4 | 1 << 3 | 1 << 2 | 1 << 1);*/	
	//Evan modify 20110523  for 3G VBUS_5V on when suspend    (GPC0[0] = "01" Output 1;)
	//sleep_config |= (1 << 8 | 1 << 7 | 1 << 5 | 1 << 6 | 1<< 0 );
	//sleep_config &= ~( 1 << 9 | 1 << 6 | 1<< 4 | 1 << 2 | 1 << 1);
	writel(sleep_config, GPC0CONPDN);
	 ...
	 */
	sleep_pud = readl(GPC0PUDPDN);
	sleep_pud &= ~( 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	//Evan modify 20110523  for 3G VBUS_5V on when suspend   (GPC0[0] = "10"  Pull-up enable)
	//sleep_pud |= (1 << 1);
	//sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 0);
	writel(sleep_pud, GPC0PUDPDN);
...
void sleep_gpio_GPC1_config(void)
{
	 ...
	 */
	sleep_pud = readl(GPC1PUDPDN);
	sleep_pud &= ~( 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPC1PUDPDN);
...
void sleep_gpio_GPD0_config(void)
{
	 ...
	 *  GPD0[1] : "LCD_BL_ADJ",			GPD0[0] : " Touch_LED ";
	 *
	 *  GPIO sleep configuration:
	 *
	 ...
	 */
	/*sleep_config = readl(GPD0CONPDN);		
	sleep_config |= (1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1<< 6 | 1 << 4 | 1 << 2  | 1 << 0 );*/
	writel(sleep_config, GPD0CONPDN);
	 ...
	 */
	sleep_pud = readl(GPD0PUDPDN);
	sleep_pud |= ( 1 << 3 );
	sleep_pud &= ~( 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPD0PUDPDN);
...
void sleep_gpio_GPE0_config(void)
{
	 ...
	 *  GPIO Description:
	 *  
	 *  GPE0[7] : "CAM_D4",  		GPE0[6] : "CAM_D3"; 
	 *  GPE0[5] : "CAM_D2",  		GPE0[4] : "CAM_D1"; 	
	 *  GPE0[3] : "CAM_D0",  		GPE0[2] : "CAM_HSYNC"; 
	 *  GPE0[1] : "CAM_VSYNC",		GPE0[0] : "CAM_PCLK";
	 *
	 *  GPIO sleep configuration:
	 *
	 ...
	 */
	sleep_config = readl(GPE0CONPDN);		
	sleep_config |= (1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1<< 14 | 1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPE0CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPE0PUDPDN);
	sleep_pud &= ~( 1<< 15 | 1 << 14 | 1 << 13 | 1 << 12 );
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPE0PUDPDN);
...
void sleep_gpio_GPE1_config(void)
{
	 ...
	 *  
	 *  GPE1[4] : "NO USE"; 	
	 *  GPE1[3] : "CAM_MCLK",  		GPE1[2] : "CAM_D7"; 
	 *  GPE1[1] : "CAM_D6",			GPE1[0] : "CAM_D5";
	 *
	 *  GPIO sleep configuration:
  	 *
	 *  GPE1[4] = "10"  Input;
	 ...
	 */
	sleep_config = readl(GPE1CONPDN);		
	sleep_config |= ( 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPE1CONPDN);
	 ...
	 *  Register Bit [9 ~ 0] = 00 0000 0000
	 */
	sleep_pud = readl(GPE1PUDPDN);
	sleep_pud &= ~( 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPE1PUDPDN);
...
void sleep_gpio_GPF0_config(void)
{
	 ...
	 *  Register Bit [15 ~ 0] = 1010 1010 1010 1010
	 */
	sleep_config = readl(GPF0CONPDN);		
	sleep_config |= (1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1<< 14 | 1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPF0CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPF0PUDPDN);
	sleep_pud &= ~( 1<< 15 | 1 << 14 | 1 << 13 | 1 << 12 );
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPF0PUDPDN);
...
void sleep_gpio_GPF1_config(void)
{
	 ...
	 *  Register Bit [15 ~ 0] = 1010 1010 1010 1010
	 */
	sleep_config = readl(GPF1CONPDN);		
	sleep_config |= (1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1<< 14 | 1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPF1CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPF1PUDPDN);
	sleep_pud &= ~( 1<< 15 | 1 << 14 | 1 << 13 | 1 << 12 );
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPF1PUDPDN);
...
void sleep_gpio_GPF2_config(void)
{
	 ...
	 *  Register Bit [15 ~ 0] = 1010 1010 1010 1010
	 */
	sleep_config = readl(GPF2CONPDN);		
	sleep_config |= (1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1<< 14 | 1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPF2CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPF2PUDPDN);
	sleep_pud &= ~( 1<< 15 | 1 << 14 | 1 << 13 | 1 << 12 );
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPF2PUDPDN);
...
void sleep_gpio_GPF3_config(void)
{
	 ...
	 *  Register Bit [11 ~ 0] =  0000 0000 0000
	 */
	sleep_pud = readl(GPF3PUDPDN);
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPF3PUDPDN);
...
void sleep_gpio_GPG1_config(void)
{
	 ...
	 *  Register Bit [13 ~ 0] = 10 1010 1010 1010
	 */
	sleep_config = readl(GPG1CONPDN);		
	sleep_config |= (1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~(1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPG1CONPDN);
	 ...
	 *  Register Bit [13 ~ 0] = 00 0000 0000 0000
	 */
	sleep_pud = readl(GPG1PUDPDN);	
	sleep_pud &= ~( 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_pud &= ~( 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_pud, GPG1PUDPDN);
...
void sleep_gpio_GPG2_config(void)
{
	 ...
	 *  Register Bit [13 ~ 0] = 10 1010 1010 1010
	 */
	sleep_config = readl(GPG2CONPDN);		
	sleep_config |= (1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~(1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPG2CONPDN);
	 ...
	 *  Register Bit [13 ~ 0] = 00 0000 0000 0000
	 */
	sleep_pud = readl(GPG2PUDPDN);
	sleep_pud &= ~( 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_pud &= ~( 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_pud, GPG2PUDPDN);
...
void sleep_gpio_GPG3_config(void)
{
	 ...
	 *  Register Bit [13 ~ 0] = 10 1010 1010 1010
	 */
	sleep_config = readl(GPG3CONPDN);		
	sleep_config |= (1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~(1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPG3CONPDN);
	 ...
	 *  Register Bit [13 ~ 0] = 00 0000 0000 0000
	 */
	sleep_pud = readl(GPG3PUDPDN);
	sleep_pud &= ~( 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_pud &= ~( 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_pud, GPG3PUDPDN);
...
void sleep_gpio_GPI_config(void)
{
	 ...
	 *  Register Bit [13 ~ 0] = 10 1010 1010 1010
	 */
	sleep_config = readl(GPICONPDN);		
	sleep_config |= ( 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 12 | 1 << 10 | 1 << 8  | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPICONPDN);
	 ...
	 *  Register Bit [13 ~ 0] = 00 0000 0000 0000
	 */
	sleep_pud = readl(GPIPUDPDN);
	sleep_pud &= ~( 1 << 13 | 1 << 12 );
	sleep_pud &= ~( 1<< 11 | 1 << 10 | 1 << 9 | 1 << 8 | 1<< 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0 );
	writel(sleep_pud, GPIPUDPDN);
...
void sleep_gpio_GPJ0_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPJ0[7]: "VGL_CTRL",  GPJ0[6]: "SF_I2C_SCL0",   GPJ0[5]: "CAM_5M_PWDN",     GPJ0[4]: "LEVEL_EN";
	 *  GPJ0[3]: "EMR_EN", 	  GPJ0[2]: "PLT_RST",	    GPJ0[1]: "PEN_SLP",         GPJ0[0]: "NO USE";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPJ0[7] = "00" Output 0, GPJ0[6] = "01" Output 1, GPJ0[5] = "00" Output 0,    GPJ0[4] = "00" Output 0;
	 *  GPJ0[3] = "00" Output 0, GPJ0[2] = "00" Output 0, GPJ0[1] = "00" Output 0,    GPJ0[0] = "00" Output 0;
	 *  
	 *  Register Bit [15 ~ 0] = 0001 0000 0000 0000  
	 */
	sleep_config = readl(GPJ0CONPDN);
	sleep_config |= ( 1 << 15 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 14 | 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 4 | 1 << 2 | 1 << 0 );		
	writel(sleep_config, GPJ0CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPJ0PUDPDN);
	sleep_pud &= ~( 1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPJ0PUDPDN); 
}
...
void sleep_gpio_GPJ1_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPJ1[5]: "VDD_CAM_EN",     		GPJ1[4]: "iNAND_EN";
	 *  GPJ1[3]: "CAM_1M3_Reset", 	  	GPJ1[2]: "CAP_EN",	    GPJ1[1]: "LCD_STBYB",         GPJ1[0]: "LCD_RESET";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPJ1[5] = "01" Output 1,    GPJ1[4] = "00" Output 0;
	 *  GPJ1[3] = "00" Output 0, 	GPJ1[2] = "00" Output 0,    GPJ1[1] = "00" Output 0,    GPJ1[0] = "00" Output 0;
	 *  
	 *  Register Bit [11 ~ 0] = 0100 0000 0000
	 */
	sleep_config = readl(GPJ1CONPDN);
	sleep_config |= ( 1 << 9 | 1 << 6 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 11 | 1 << 10 | 1 << 8 | 1 << 7 | 1 << 4 | 1 << 2 | 1 << 0 );		
	writel(sleep_config, GPJ1CONPDN);
	 ...
	 */
	sleep_pud = readl(GPJ1PUDPDN);
	sleep_pud &= ~( 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPJ1PUDPDN);
...
void sleep_gpio_GPJ2_config(void)
{
	 ...
	 *  GPJ2[3]: "LDO2_ENA", 	GPJ2[2]: "VGH_CTRL", GPJ2[1]: "WF_RSTn",    GPJ2[0]: "HDMI_EN";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPJ2[7] = "11" Previous, GPJ2[6] = "11" Previous, GPJ2[5] = "11" Previous, GPJ2[4] = "00" Output 0;
	 *  GPJ2[3] = "00" Output 0, GPJ2[2] = "00" Output 0, GPJ2[1] = "00" Output 0, GPJ2[0] = "01" Output 1;
	 *  
	 *  Register Bit [15 ~ 0] = 1111 1100 0000 0001
	 */
	sleep_config = readl(GPJ2CONPDN);
	sleep_config |= (1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 7 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 9 | 1 << 8 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 2 | 1 << 0);
	writel(sleep_config, GPJ2CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPJ2PUDPDN);
	sleep_pud &= ~( 1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPJ2PUDPDN);
...
void sleep_gpio_GPJ3_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPJ3[7]: "IOC_RST",  GPJ3[6]: "IOC_POWER",   GPJ3[5]: "BT_RSTn",  GPJ3[4]: "Touch_pannel_RESET";
	 *  GPJ3[3]: "GPS_PWR_EN", 	GPJ3[2]: "QReset", GPJ3[1]: "+15V_CTL",    GPJ3[0]: "LCD_BL_EN";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPJ3[7] = "00" Output 0, GPJ3[6] = "00" Output 0, GPJ3[5] = "00" Output 0,    GPJ3[4] = "00" Output 0;
	 *  GPJ3[3] = "01" Output 1, GPJ3[2] = "00" Output 0, GPJ3[1] = "00" Output 0,    GPJ3[0] = "00" Output 0;
	 *  
	 *  Register Bit [15 ~ 0] = 0000 0000 0100 0000
	 */
	sleep_config = readl(GPJ3CONPDN);
	sleep_config |= (1 << 15 | 1 << 14 | 1 << 13 | 1 << 11 | 1 << 9 | 1 << 7 | 1 << 4);
	sleep_config &= ~( 1 << 12 | 1 << 10 | 1 << 8 | 1 << 6 | 1 << 5 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);		
	writel(sleep_config, GPJ3CONPDN);
	 ...
	 *  Register Bit [15 ~ 0] = 0000 0000 0000 0000
	 */
	sleep_pud = readl(GPJ3PUDPDN);
	sleep_pud &= ~( 1 << 15 | 1 << 14 | 1 << 13 | 1 << 12 | 1 << 11 | 1 << 10 | 1 << 9 | 1 << 8 );
	sleep_pud &= ~( 1 << 7 | 1 << 6 | 1 << 5 | 1 << 4 | 1 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
	writel(sleep_pud, GPJ3PUDPDN);
...
void sleep_gpio_GPJ4_config(void)
{
	 ...
	 *
  	 *  GPIO Description:
	 *  GPJ4[4]: "EXT_CARD_EN";
	 *  GPJ4[3]: "SHTDN", 	GPJ4[2]: "LDO1_ENA",     GPJ4[1]: "IOC_DATA",    GPJ4[0]: "IOC_CLK";
         *
	 *  GPIO sleep configuration:
	 *
	 *  GPJ4[4] = "01" Output 1;
	 *  GPJ4[3] = "00" Output 0,   GPJ4[2] = "00" Output 0,   GPJ4[1] = "00" Output 0,    GPJ4[0] = "00" Output 0;
	 *  
	 *  Register Bit [9 ~ 0] = 01 0000 0000 
	 */
	sleep_config = readl(GPJ4CONPDN);
	sleep_config |= ( 1 << 8 | 1 << 6 | 1 << 5 | 1 << 3 | 1 << 1);
	sleep_config &= ~( 1 << 9 | 1 << 7 | 1 << 4 | 1 << 2 | 1 << 0 );		
	writel(sleep_config, GPJ4CONPDN);
...
{
	sleep_gph0_pud = GPH0PUD;
	sleep_gph1_pud = GPH1PUD;
	sleep_gph2_pud = GPH2PUD;
	sleep_gph3_pud = GPH3PUD;
}

void resume_gpio_GPH_PUD_restore(void)
{
	GPH0PUD = sleep_gph0_pud;
	GPH0PUD = sleep_gph1_pud;
	GPH0PUD = sleep_gph2_pud;
	GPH0PUD = sleep_gph3_pud;
}
...
void sleep_gpio_GPH_config(void)
{
     ...
     */
#if 1
    sleep_config = GPH0CON;    
    sleep_config &= ~( 0xF << 7*4 | 0xF << 3*4 | 0xF << 2*4 );
	sleep_config |= ( 0x1 << 7*4 | 0x1 << 3*4 | 0x0 << 2*4 );
    GPH0CON = sleep_config;                                                                                                   
                                                                                                                                             
    sleep_dat = GPH0DAT;                                                                                                      
    sleep_dat &= ~( 0x1 << 7*1 | 0x1 << 3*1 | 0x1 << 2*1 );
    GPH0DAT = sleep_config; 
#endif
