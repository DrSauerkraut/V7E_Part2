...
void start_armboot (void)
{
	...
	int mmc_dev_num = 0;
	int boot_flag = 0;
	ulong boot_ch = *(volatile u32 *)(0xD0037488);
...
//if battery voltage is less than 3.6v,system cann't boot.
//printf("power check\n");
//power_off_lb();
...
//******************************//
	...
	if (INF_REG3_REG == BOOT_ONENAND) {
		...
		mmc_initialize(gd->bd, mmc_dev_num);
	#endif
...
/*
	...
	if (share_region_handle() != 0) {
		run_command("setenv bootcmd run bootcmd_recovery", 0);
	}
#endif*/
	
#ifdef CONFIG_CMD_SMT
	//Production-line flow
	if (boot_ch == ELFIN_HSMMC_2_BASE) {
		#ifdef CONFIG_SHARE_REGION
			set_share_region(1);
		#endif
		run_command("setenv bootcmd run bootcmd_smt", 0);
	}
#endif
...
////////////////////////////////////////////////////////////////////////////////////////
	...
	/* main_loop() can return to retry autoboot, if so just run it agai  0n                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                . */
...
void export_c_fun(void)  
{
	interrupt_init();             //    very importent
}
